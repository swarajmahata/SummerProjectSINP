...
# --- Plot ---
plt.figure()
plt.plot(m_x_vals, rates["C"], linestyle=':', linewidth=2, label=r"$^{12}$C: $E_{R,\mathrm{th}}=1.92$ keV")
plt.plot(m_x_vals, rates["F"], linestyle='--', linewidth=2, label=r"$^{19}$F: $E_{R,\mathrm{th}}=1.92$ keV")
...
plt.legend()
plt.tight_layout()
plt.savefig("Rate_vs_Mass_CSV_Efficiency_Adjusted.png")
plt.show()
