...
# --- Plot ---
plt.figure()
plt.plot(m_x_vals, sigma_limits_default, linestyle='--', color='blue', label=r"$T = 35^\circ$C, $\eta_T = 50\%$")
plt.plot(m_x_vals, sigma_limits_seitz, linestyle='-', color='red', linewidth=2, label=r"$T = 55^\circ$C, $\eta_T = 50\%$")
plt.xlabel("Mass (GeV)")
